...
// do to constructeur
Joueur::Joueur() {
	nom_ = "inconnu", matchsJoues_ = 0, buts_ = 0, assists_ = 0,attaque_ = defense_ = 0;
}
Joueur::Joueur(string nom, unsigned int matchsJoues,
	unsigned int buts, unsigned int assists,
	double attaque, double defense) :nom_(nom), matchsJoues_(matchsJoues), buts_(buts),
	assists_(assists), attaque_(attaque), defense_(defense)
{
...
{
	os << individu.nom_ << " " << individu.matchsJoues_ << " " << individu.buts_ << " " << individu.assists_ << " " <<
